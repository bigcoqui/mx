...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode)
	{
		...
		{
			case UP_DOWN:
				dPad.add(add(buttonUp = createButton(0, FlxG.height - 255, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonDown = createButton(0, FlxG.height - 135, 132, 127, 'down', 0xFFD6D6)));
			case LEFT_RIGHT:
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 135, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight = createButton(127, FlxG.height - 135, 132, 127, 'right', 0xB44C34)));
			case UP_LEFT_RIGHT:
				dPad.add(add(buttonUp = createButton(105, FlxG.height - 243, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 135, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight = createButton(207, FlxG.height - 135, 132, 127, 'right', 0xB44C34)));
			case LEFT_FULL:
				dPad.add(add(buttonUp = createButton(105, FlxG.height - 345, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 243, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight = createButton(207, FlxG.height - 243, 132, 127, 'right', 0xB44C34)));
				dPad.add(add(buttonDown = createButton(105, FlxG.height - 135, 132, 127, 'down', 0xFFD6D6)));
			case RIGHT_FULL:
				dPad.add(add(buttonUp = createButton(FlxG.width - 258, FlxG.height - 408, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonLeft = createButton(FlxG.width - 384, FlxG.height - 309, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight = createButton(FlxG.width - 132, FlxG.height - 309, 132, 127, 'right', 0xB44C34)));
				dPad.add(add(buttonDown = createButton(FlxG.width - 258, FlxG.height - 201, 132, 127, 'down', 0xFFD6D6)));
			case BOTH_FULL:
				dPad.add(add(buttonUp = createButton(105, FlxG.height - 345, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonLeft = createButton(0, FlxG.height - 243, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight = createButton(207, FlxG.height - 243, 132, 127, 'right', 0xB44C34)));
				dPad.add(add(buttonDown = createButton(105, FlxG.height - 135, 132, 127, 'down', 0xFFD6D6)));
				dPad.add(add(buttonUp2 = createButton(FlxG.width - 258, FlxG.height - 408, 132, 127, 'up', 0x416600)));
				dPad.add(add(buttonLeft2 = createButton(FlxG.width - 384, FlxG.height - 309, 132, 127, 'left', 0xD3A625)));
				dPad.add(add(buttonRight2 = createButton(FlxG.width - 132, FlxG.height - 309, 132, 127, 'right', 0xB44C34)));
				dPad.add(add(buttonDown2 = createButton(FlxG.width - 258, FlxG.height - 201, 132, 127, 'down', 0xFFD6D6)));
